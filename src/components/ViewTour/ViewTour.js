...
function loadR1(data_id)
{
  ...
  function monke(){
    ...
    return (
      ...
      <div class="Bracket">
       ...
       <div class="grp1">
         <h4>R1</h4>
          ...
          <br/>
          <input type="text" placeholder="TBD" class="seed" id="1.2" readOnly  /> <input type="text" class="seedscr" id="1.2s" readOnly/>
      ...
      <footer>
        <button class="bg" onClick={monke}>loadTeams</button>
      <br/>
